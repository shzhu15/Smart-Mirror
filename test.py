...
#    Dec 05, 2018 11:35:55 PM MST  platform: Windows NT
...
class GUI:
    def __init__(self, top=None):
        ...
        font11 = "-family {Segoe UI Black} -size 18 -weight bold "  \
            "-slant roman -underline 0 -overstrike 0"
        font12 = "-family {Segoe UI} -size 30 -weight normal -slant "  \
            "roman -underline 0 -overstrike 0"
        font14 = "-family {Segoe UI} -size 12 -weight normal -slant "  \
            "roman -underline 0 -overstrike 0"
        font27 = "TkDefaultFont"
        font30 = "TkDefaultFont"
        font9 = "-family {Segoe UI} -size 18 -weight normal -slant "  \
            "roman -underline 0 -overstrike 0"

        top.geometry("900x1600+1326+15")
        ...
        self.Time_Time.configure(font=font12)
        ...
        self.Time_Date.configure(font=font12)
        ...
        self.CalendarDay_2.configure(font=font11)
        ...
        self.CalendarDay_3.configure(font=font11)
        ...
        self.CalendarDayEvents_1.configure(highlightbackground="#d9d9d9")
        self.CalendarDayEvents_1.configure(highlightcolor="black")
        self.CalendarDayEvents_1.configure(relief='flat')
        self.CalendarDayEvents_1.configure(selectbackground="#c4c4c4")
        self.CalendarDayEvents_1.configure(selectforeground="black")
        ...
        self.News_SectionTitle.place(relx=0.667, rely=0.038, height=31
                , width=304)
        self.News_SectionTitle.configure(activebackground="#f9f9f9")
        self.News_SectionTitle.configure(activeforeground="black")
        self.News_SectionTitle.configure(background="#000000")
        self.News_SectionTitle.configure(disabledforeground="#a3a3a3")
        self.News_SectionTitle.configure(font=font9)
        self.News_SectionTitle.configure(foreground="#ffffff")
        self.News_SectionTitle.configure(highlightbackground="#d9d9d9")
        ...
        self.News_Stories.place(relx=0.611, rely=0.15, relheight=0.294
                , relwidth=0.333)
        ...
        self.News_Stories.configure(highlightbackground="#d9d9d9")
        self.News_Stories.configure(highlightcolor="black")
        self.News_Stories.configure(highlightthickness="0")
        self.News_Stories.configure(relief='flat')
        self.News_Stories.configure(selectbackground="#c4c4c4")
        self.News_Stories.configure(selectforeground="black")
        ...
        self._img1 = tk.PhotoImage(file="./cloudy.png")
        ...
        self.Weather_Temperature.place(relx=0.156, rely=0.119, height=51
                , width=79)
        self.Weather_Temperature.configure(activebackground="#f9f9f9")
        self.Weather_Temperature.configure(activeforeground="black")
        self.Weather_Temperature.configure(background="#000000")
        self.Weather_Temperature.configure(disabledforeground="#a3a3a3")
        self.Weather_Temperature.configure(font=font12)
        self.Weather_Temperature.configure(foreground="#ffffff")
        self.Weather_Temperature.configure(highlightbackground="#d9d9d9")
        self.Weather_Temperature.configure(highlightcolor="black")
        ...
        self.Weather_HighLow.configure(activebackground="#f9f9f9")
        self.Weather_HighLow.configure(activeforeground="black")
        self.Weather_HighLow.configure(background="#000000")
        self.Weather_HighLow.configure(disabledforeground="#a3a3a3")
        self.Weather_HighLow.configure(font=font14)
        self.Weather_HighLow.configure(foreground="#ffffff")
        self.Weather_HighLow.configure(highlightbackground="#d9d9d9")
        self.Weather_HighLow.configure(highlightcolor="black")
        ...
        self.Weather_FeelsLike.configure(activebackground="#f9f9f9")
        self.Weather_FeelsLike.configure(activeforeground="black")
        self.Weather_FeelsLike.configure(background="#000000")
        self.Weather_FeelsLike.configure(disabledforeground="#a3a3a3")
        self.Weather_FeelsLike.configure(font=font14)
        self.Weather_FeelsLike.configure(foreground="#ffffff")
        self.Weather_FeelsLike.configure(highlightbackground="#d9d9d9")
        self.Weather_FeelsLike.configure(highlightcolor="black")
        self.Weather_FeelsLike.configure(text='''Feels Like 21''')


f clock():
obal the_time
ur = datetime.datetime.now().hour
 hour % 12 == hour:
eridian = "AM"
se:
eridian = "PM"
nutes = datetime.datetime.now().minute
conds = datetime.datetime.now().second
e_time = '' + str(hour % 12) + ':' + str(minutes) + ':' + str(seconds) + ' ' + meridian
lf.Time_Time.config(text=the_time)
lf.Time_Time.after(1000, clock)  # run itself again after 1000 ms

reate the function that edits the widgets here
 news():
port requests
l = ('https://newsapi.org/v2/top-headlines?'
  'country=us&'
  'apiKey=080248f839564772b9e5d8a39dfae1d5')
sponse = requests.get(url)
lf.News_Stories.config(text=response)
lf.News_Stories.after(90000000, news)  # run itself again after 1000 ms
